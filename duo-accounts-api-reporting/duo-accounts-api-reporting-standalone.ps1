...
function Get-UnixStartDate() {
    ...
    # I threw this in for the new v2 of the user actions endpoint. More updates to come
    # as I adjust the script to accomodate v2 of other endpoints
...
# Initialize a hashtable to count admins that use bypass
$bypassAdmins = @{}
...
ForEach ($org in $all_accts) {
    ...
    # Update running total of bypass events per admin
